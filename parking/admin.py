...
class VehicleAdmin(admin.ModelAdmin):
    list_display = ('plate_number', 'model', 'brand',
                    'color', 'owner', 'created_at')
...
class ReservationAdmin(admin.ModelAdmin):
    list_display = ('user', 'vehicle', 'parking_slot',
...
class ReservationTicketAdmin(admin.ModelAdmin):
    list_display = ('ticket_number', 'reservation', 'issued_at',
                    'is_paid', 'status', 'validated_at')
    search_fields = ('ticket_number', 'reservation__id',
